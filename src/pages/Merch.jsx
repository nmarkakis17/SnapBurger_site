...
const items = [
  ...
  {name:'Theo Sticker Set', price:4.99, img:'/images/snapburger-sticker.png', alt:'Theo sticker (placeholder image)'},
]
      ...
      <div style={{display:'grid', gap:12, gridTemplateColumns:'repeat(auto-fit, minmax(220px, 1fr))'}}>
        {items.map(it => (
          <div key={it.name} style={{border:'1px solid #e2e8f0', borderRadius:16, padding:'1rem', display:'grid', gap:8}}>
            <div style={{height:220, background:'#f1f5f9', borderRadius:12, overflow:'hidden', display:'grid', placeItems:'center'}}>
